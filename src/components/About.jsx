  ...
  <section className="section about-section" id="about">
    ...
    <div className="about-grid">
      ...
      <motion.div className="about-copy" initial={{ opacity: 0, y: 32 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: .3 }} transition={{ duration: .7 }}>
        ...
        <div className="about-tags"><span>Distributed systems</span><span>Python APIs</span><span>Azure cloud</span><span>Product engineering</span><span>AI-assisted development</span></div>
