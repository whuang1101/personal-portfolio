...
const AboutPage = () => (
  <section className="section about-section" id="about">
    <motion.div className="section-kicker" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true, amount: 0.15, margin: "0px 0px -10% 0px" }}><span>01</span> Field note / About</motion.div>
    <div className="about-grid">
      <motion.div className="portrait-wrap" initial={{ opacity: 0, x: -18 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, amount: 0.15, margin: "0px 0px -10% 0px" }} transition={{ duration: .7 }}>
      ...
      <motion.div className="about-copy" initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.15, margin: "0px 0px -10% 0px" }} transition={{ duration: .7 }}>
    ...
    <motion.div className="personal-field-notes" initial={{ opacity: 0, y: 18 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.15, margin: "0px 0px -10% 0px" }}>
